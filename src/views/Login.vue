...
const loginUser = () => {
    ...
    authStore.userLogin({
        ...
        show_popup_success(toast, "Login Successful", "SuccessFul")
...
<div class="container login-container mt-4">
    ...
    <div class="text-center mb-5">
        ...
        <div class="text-900 text-3xl font-medium mb-3">Shop Login</div>
        <span class="text-600 font-medium line-height-3">Don't have an account?</span>
        <a class="font-medium no-underline ml-2 text-blue-500 cursor-pointer" @click="redirectToRegister">Create today!</a>
    </div>
    ...
    <div>
        <form method="POST" @submit.prevent="loginUser" >
            ...
            <Button :loading="is_loading" label="Sign In" type="submit" icon="pi pi-user" class="w-full" ></Button>
        </form>
